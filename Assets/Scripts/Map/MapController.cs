...
public class MapController : MonoBehaviour
{
	...
	void Start()
	{
		pm = FindAnyObjectByType<PlayerAnimationManager>();
	}
	...
	void ChunkChecker()
	{
		...
		if (pm.moveAmt.x > 0 && pm.moveAmt.y == 0)
		{
		...
		else if (pm.moveAmt.x < 0 && pm.moveAmt.y == 0)
		{
		...
		else if (pm.moveAmt.y > 0 && pm.moveAmt.x == 0)
		{
